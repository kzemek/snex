defmodule Snex.Interpreter do
  ...
  def start_link(opts \\ []) do
    {args, genserver_opts} = Keyword.split(opts, [:python, :cd, :environment, :init_script, :sync_start?])
  ...
  defp init_python_port(opts) do
    ...
    pythonpath =
      case get_in(opts[:environment]["PYTHONPATH"]) || System.get_env("PYTHONPATH") do
        nil -> snex_pythonpath
