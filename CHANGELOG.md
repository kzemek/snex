...
- **`snex` Python module documentation**
  ...
  Available through `mix docs`, or [on HexDocs](https://hexdocs.pm/snex/Python_Interface_Documentation.html) once the release is published.
...
- **Multiprocessing support**
  ...
  See [`snex.serve` documentation](https://hexdocs.pm/snex/Python_Interface_Documentation.html#snex.serve/2) for a working example.
